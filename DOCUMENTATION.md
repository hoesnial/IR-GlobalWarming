...
6.  **FR-06**: Sistem menghitung skor relevansi dokumen terhadap query menggunakan TF-IDF dan Cosine Similarity.
7.  **FR-07**: Sistem menampilkan hasil pencarian yang diurutkan berdasarkan skor relevansi (Ranking).
8.  **FR-08**: Sistem menampilkan ringkasan (summary) dan kata kunci (keywords) untuk setiap dokumen hasil pencarian.
